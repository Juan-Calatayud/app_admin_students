				...
				<div class="col-md-9">
						<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
							<div class="form-group">
								...
								<input type="text" value="<?php echo $datos['nombre']; ?>" name="nombre" class="form-control" required="">
							</div>
							<div class="form-group">
								<label for="inputEmail" class="control-label">Edad</label>
								<input type="number" value="<?php echo $datos['edad']; ?>" name="edad" class="form-control" required="">
							</div>
							<div class="form-group">
								<label for="inputEmail" class="control-label">Promedio</label>
								<input type="number" value="<?php echo $datos['promedio']; ?>" name="promedio" class="form-control" required="">
							</div>
							<div class="form-group">
